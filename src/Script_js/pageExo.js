...
function definitionDraggable() {
    ...
    $("#page").droppable({
        ...
        onClick = "supprimerExo(this)" > ❌ < /button> <p class="pVraiFaux">---------------Vrai----Faux</p > < /div>`
                ...
                htmlNouvelExercice = `<div class ="divVraiOuFaux classeDeBase  choixPhrase" id="idGuid"> <button class = "supprimer" onClick="supprimerExo(this)">❌</button> <div>  <div class = "phraseGauche"><input type="text" maxlength="35" name="VouF" class="inputVraiF  all input-utilisateur entoureMotsExo phraseGauchecss" />  </div>     <div class = "phraseDroite"><input type="text" maxlength="55" name="VouF" class="inputVraiF  all input-utilisateur entoureMotsExo phraseDroitecss1 " /><input type="text" maxlength="55" name="VouF" class="inputVraiF  all input-utilisateur entoureMotsExo phraseDroitecss1 " /><input type="text" maxlength="55" name="VouF" class="inputVraiF  all input-utilisateur entoureMotsExo phraseDroitecss1 " /></div></div> </div>`
