...
function definitionDraggable() {
    ...
    $("#page").droppable({
        ...
        onClick = "supprimerExo(this)" > ❌ < /button> <p class="pVraiFaux">---------------Vrai----Faux</p > < /div>`
                ...
                htmlNouvelExercice = `<div class ="divVraiOuFaux classeDeBase" id="idGuid"><input type="text" name="VouF" class="rond all input-utilisateur" maxlength="1"/><input type="text" name="VouF" maxlength = "70" class="consigne2 all input-utilisateur" /> <button class = "supprimer" onClick="supprimerExo(this)">❌</button> </div>`
                ...
                htmlNouvelExercice = `<div class =" classeDeBase " id="idGuid"><button class = "enteteBouton supprimer" onClick="supprimerExo(this)">❌</button><div class = "boiteEntete"><p class = "prenom">Prénom__________</p><p class = "date">Date:____/______/_____</p> </div><div class="Entete"><div class = "left"><input type="text"  class="top input-utilisateur" value = "Titre"/><input type="text"  class="bot input-utilisateur"  value = "Auteur"/> </div>   <div class = "right"><div class = "lectureLeft"><input type="text"  value = "Lecture" maxlength="22"class="lecture input-utilisateur alignCenter" /><input type="text" maxlength="22" value = "Texte " class="lecture2 input-utilisateur alignCenter" /></div> <div class = " lectureRight"> <input type="text"  value = "Groupe" class="groupe input-utilisateur alignCenter " maxlength="8" cols="40" rows="5"/> </div></div> </div></div>`
